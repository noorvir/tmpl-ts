...
const api = {
  ...
  ensureMicPermission: async (): Promise<boolean> =>
    ipcRenderer.invoke("permissions:microphone"),
  ...
  // audio save
  saveAudio: async (buffer: Buffer): Promise<string> =>
    ipcRenderer.invoke("audio:save", buffer),
  ...
  setHotkey: async (
    ...
    ipcRenderer.invoke("settings:setHotkey", accelerator),
  openSettings: (): void => {
